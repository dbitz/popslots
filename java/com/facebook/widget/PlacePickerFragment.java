...
public class PlacePickerFragment extends PickerFragment<GraphPlace> {
    ...
    public void onInflate(Activity activity, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        setRadiusInMeters(a.getInt(R.styleable.com_facebook_place_picker_fragment_radius_in_meters, this.radiusInMeters));
        setResultsLimit(a.getInt(R.styleable.com_facebook_place_picker_fragment_results_limit, this.resultsLimit));
        ...
        this.showSearchBox = a.getBoolean(R.styleable.com_facebook_place_picker_fragment_show_search_box, this.showSearchBox);
        a.recycle();
    }
        ...
        PickerFragmentAdapter<GraphPlace> adapter = new PickerFragmentAdapter<GraphPlace>(getActivity()) {
            protected CharSequence getSubTitleOfGraphObject(GraphPlace graphObject) {
                ...
                if (category != null && wereHereCount != null) {
                    return PlacePickerFragment.this.getString(R.string.com_facebook_placepicker_subtitle_format, new Object[]{category, wereHereCount});
                } else if (category == null && wereHereCount != null) {
                    return PlacePickerFragment.this.getString(R.string.com_facebook_placepicker_subtitle_were_here_only_format, new Object[]{wereHereCount});
                } else if (category == null || wereHereCount != null) {
                    return null;
                } else {
                    return PlacePickerFragment.this.getString(R.string.com_facebook_placepicker_subtitle_catetory_only_format, new Object[]{category});
                }
            }
