...
public class AppEventsLogger {
    ...
    static class AppEvent implements Serializable {
        ...
        public AppEvent(Context context, String eventName, Double valueToSum, Bundle parameters, boolean isImplicitlyLogged) {
            try {
                ...
                if (this.isImplicit) {
                    this.jsonObject.put("_implicitlyLogged", HSConsts.STATUS_INPROGRESS);
                }
    ...
    static class SessionEventsState {
        ...
        private byte[] getStringAsByteArray(String jsonString) {
            byte[] jsonUtf8 = null;
            try {
                jsonUtf8 = jsonString.getBytes(Constants.ENCODING);
            } catch (Exception e) {
    ...
    private static void flushAndWait(com.facebook.AppEventsLogger.FlushReason r6) {
        ...
        r5 = staticLock;
        monitor-enter(r5);
        r4 = requestInFlight;	 Catch:{ all -> 0x004b }
    ...
    L_0x0009:
        r4 = 1;
        requestInFlight = r4;	 Catch:{ all -> 0x004b }
        r3 = new java.util.HashSet;	 Catch:{ all -> 0x004b }
        r4 = stateMap;	 Catch:{ all -> 0x004b }
        r4 = r4.keySet();	 Catch:{ all -> 0x004b }
        r3.<init>(r4);	 Catch:{ all -> 0x004b }
        monitor-exit(r5);	 Catch:{ all -> 0x004b }
        accumulatePersistedEvents();
        r1 = 0;
        r1 = buildAndExecuteRequests(r6, r3);	 Catch:{ Exception -> 0x004e }
    L_0x0020:
        r5 = staticLock;
        monitor-enter(r5);
        r4 = 0;
        requestInFlight = r4;	 Catch:{ all -> 0x0058 }
