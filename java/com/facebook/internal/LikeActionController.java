...
public class LikeActionController {
    ...
    private class GetOGObjectIdRequestWrapper extends AbstractRequestWrapper {
        ...
        protected void processSuccess(Response response) {
            ...
            if (results != null) {
                ...
                if (ogObject != null) {
                    this.verifiedObjectId = ogObject.optString(LoginRequest.KEY_ID);
                }
            }
        }
    }
            ...
            if (dataSet != null) {
                for (int i = 0; i < dataSet.length(); i++) {
                    ...
                    if (data != null) {
                        ...
                        if (appData != null && Utility.areObjectsEqual(LikeActionController.this.session.getApplicationId(), appData.optString(LoginRequest.KEY_ID))) {
                            this.unlikeToken = data.optString(LoginRequest.KEY_ID);
                        }
                    }
                }
            }
    ...
    private class GetPageIdRequestWrapper extends AbstractRequestWrapper {
        ...
        GetPageIdRequestWrapper(String objectId) {
            ...
            pageIdRequestParams.putString("fields", LoginRequest.KEY_ID);
        ...
        protected void processSuccess(Response response) {
            JSONObject results = Utility.tryGetJSONObjectFromResponse(response.getGraphObject(), this.objectId);
            if (results != null) {
                this.verifiedObjectId = results.optString(LoginRequest.KEY_ID);
    ...
    private class PublishLikeRequestWrapper extends AbstractRequestWrapper {
        ...
        protected void processSuccess(Response response) {
            this.unlikeToken = Utility.safeGetStringFromResponse(response.getGraphObject(), LoginRequest.KEY_ID);
        }
...
*/
        /*
        r1 = 0;
        r2 = controllerDiskCache;	 Catch:{ IOException -> 0x0014, all -> 0x0023 }
        r1 = r2.openPutStream(r4);	 Catch:{ IOException -> 0x0014, all -> 0x0023 }
        r2 = r5.getBytes();	 Catch:{ IOException -> 0x0014, all -> 0x0023 }
        r1.write(r2);	 Catch:{ IOException -> 0x0014, all -> 0x0023 }
    ...
    L_0x0014:
        r0 = move-exception;
        r2 = TAG;	 Catch:{ IOException -> 0x0014, all -> 0x0023 }
        r3 = "Unable to serialize controller to disk";	 Catch:{ IOException -> 0x0014, all -> 0x0023 }
        android.util.Log.e(r2, r3, r0);	 Catch:{ IOException -> 0x0014, all -> 0x0023 }
        if (r1 == 0) goto L_0x0013;
    L_0x001f:
        com.facebook.internal.Utility.closeQuietly(r1);
        goto L_0x0013;
    ...
    private static LikeActionController deserializeFromJson(String controllerJsonString) {
        try {
            ...
            LikeActionController controller = new LikeActionController(Session.getActiveSession(), controllerJson.getString(JSON_STRING_OBJECT_ID_KEY));
