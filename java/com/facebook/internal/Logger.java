...
public class Logger {
    ...
    public void setPriority(int value) {
        Validate.oneOf(Integer.valueOf(value), KeyValueStoreColumns.value, Integer.valueOf(7), Integer.valueOf(3), Integer.valueOf(6), Integer.valueOf(4), Integer.valueOf(2), Integer.valueOf(5));
        this.priority = value;
    }
