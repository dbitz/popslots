...
class DeviceInfo {
    ...
    private String getScreenDensity(DisplayMetrics displayMetrics) {
        ...
        if (density > BaseRequest.InitBuddyList) {
    ...
    private String getFacebookAttributionId(Context context) {
        try {
            ...
            String columnName = Facebook.ATTRIBUTION_ID_COLUMN_NAME;
            Cursor cursor = contentResolver.query(uri, new String[]{Facebook.ATTRIBUTION_ID_COLUMN_NAME}, null, null, null);
            if (cursor == null) {
                return null;
            }
            if (cursor.moveToFirst()) {
                String attributionId = cursor.getString(cursor.getColumnIndex(Facebook.ATTRIBUTION_ID_COLUMN_NAME));
                cursor.close();
