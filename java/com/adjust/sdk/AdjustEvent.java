...
public class AdjustEvent {
    ...
    public void addCallbackParameter(String key, String value) {
        if (isValidParameter(key, KeyValueStoreColumns.key, "Callback") && isValidParameter(value, KeyValueStoreColumns.value, "Callback")) {
    ...
    public void addPartnerParameter(String key, String value) {
        if (isValidParameter(key, KeyValueStoreColumns.key, "Partner") && isValidParameter(value, KeyValueStoreColumns.value, "Partner")) {
