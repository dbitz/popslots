...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.authorizationClient.setBackgroundProcessingListener(new BackgroundProcessingListener() {
            public void onBackgroundProcessingStarted() {
                View progressBarView = LoginActivity.this.findViewById(R.id.com_facebook_login_activity_progress_bar);
    ...
    public void onPause() {
        ...
        View progressBarView = findViewById(R.id.com_facebook_login_activity_progress_bar);
        if (progressBarView != null) {
            progressBarView.setVisibility(8);
        }
    }
