...
public class DefaultChannelGroupFuture implements ChannelGroupFuture {
    ...
    public synchronized boolean isPartialSuccess() {
        boolean z;
        z = (this.futures.isEmpty() || this.successCount == 0) ? false : true;
        return z;
    }

    public synchronized boolean isPartialFailure() {
        boolean z;
        z = (this.futures.isEmpty() || this.failureCount == 0) ? false : true;
        return z;
    }
    ...
    private void checkDeadLock() {
        if (((Boolean) IoWorkerRunnable.IN_IO_THREAD.get()).booleanValue()) {
