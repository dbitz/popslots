    ...
    private static abstract class OpenGraphDialogBuilderBase<CONCRETE extends OpenGraphDialogBuilderBase<?>> extends Builder<CONCRETE> {
            ...
            try {
                ...
                if (object == null) {
                    ...
                    for (String url : attachmentUrls) {
                        ...
                        graphObject.setProperty(Values.URL, url);
                        if (isUserGenerated) {
        ...
        private Object flattenObject(Object object) throws JSONException {
            ...
            if (object instanceof JSONObject) {
                ...
                if (jsonObject.has(LoginRequest.KEY_ID)) {
                    return jsonObject.getString(LoginRequest.KEY_ID);
                }
                if (jsonObject.has(Values.URL)) {
                    return jsonObject.getString(Values.URL);
                }
                return object;
