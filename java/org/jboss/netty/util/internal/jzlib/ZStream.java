...
public final class ZStream {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            try {
                $SwitchMap$org$jboss$netty$util$internal$jzlib$JZlib$WrapperType[WrapperType.ZLIB.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$org$jboss$netty$util$internal$jzlib$JZlib$WrapperType[WrapperType.GZIP.ordinal()] = 2;
    ...
    public int deflateInit(int level, int bits, Enum wrapperType) {
        ...
        return this.dstate.deflateInit(this, level, bits, (WrapperType) wrapperType);
    }
    ...
    int read_buf(byte[] buf, int start, int size) {
        ...
        this.avail_in -= len;
        switch (AnonymousClass1.$SwitchMap$org$jboss$netty$util$internal$jzlib$JZlib$WrapperType[this.dstate.wrapperType.ordinal()]) {
