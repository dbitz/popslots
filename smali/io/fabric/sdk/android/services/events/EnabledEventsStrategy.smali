...
.method sendAndCleanUpIfSuccess()V
    ...
    const-string/jumbo v6, "skipping files send because we don\'t yet know the target endpoint"
    ...
    const-string/jumbo v6, "Sending all files"
    ...
    const-string/jumbo v7, "attempt to send batch of %d files"
    ...
    const-string/jumbo v7, "Failed to send batch of analytics files to server: "
