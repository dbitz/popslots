...
public class Util {
    ...
    public static <T> T readObject(android.content.Context r11, java.lang.String r12, java.lang.String r13, java.lang.Class<T> r14) {
        ...
        r1 = 0;
        r4 = 0;
        r3 = r11.openFileInput(r12);	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        r1 = r3;
        r0 = new java.io.BufferedInputStream;	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        r0.<init>(r3);	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        r1 = r0;
        r5 = new java.io.ObjectInputStream;	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        r5.<init>(r0);	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        r1 = r5;
        r6 = r5.readObject();	 Catch:{ ClassNotFoundException -> 0x0034, ClassCastException -> 0x005f, Exception -> 0x008d, FileNotFoundException -> 0x004d }
        r4 = r14.cast(r6);	 Catch:{ ClassNotFoundException -> 0x0034, ClassCastException -> 0x005f, Exception -> 0x008d, FileNotFoundException -> 0x004d }
        r6 = getLogger();	 Catch:{ ClassNotFoundException -> 0x0034, ClassCastException -> 0x005f, Exception -> 0x008d, FileNotFoundException -> 0x004d }
        r7 = "Read %s: %s";
        r8 = 2;
        r8 = new java.lang.Object[r8];	 Catch:{ ClassNotFoundException -> 0x0034, ClassCastException -> 0x005f, Exception -> 0x008d, FileNotFoundException -> 0x004d }
        r9 = 0;
        r8[r9] = r13;	 Catch:{ ClassNotFoundException -> 0x0034, ClassCastException -> 0x005f, Exception -> 0x008d, FileNotFoundException -> 0x004d }
        r9 = 1;
        r8[r9] = r4;	 Catch:{ ClassNotFoundException -> 0x0034, ClassCastException -> 0x005f, Exception -> 0x008d, FileNotFoundException -> 0x004d }
        r6.debug(r7, r8);	 Catch:{ ClassNotFoundException -> 0x0034, ClassCastException -> 0x005f, Exception -> 0x008d, FileNotFoundException -> 0x004d }
    L_0x002e:
    ...
    L_0x0034:
        r2 = move-exception;
        r6 = getLogger();	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        r7 = "Failed to find %s class (%s)";
        r8 = 2;
        r8 = new java.lang.Object[r8];	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        r9 = 0;
        r8[r9] = r13;	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        r9 = 1;
        r10 = r2.getMessage();	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        r8[r9] = r10;	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        r6.error(r7, r8);	 Catch:{ FileNotFoundException -> 0x004d, Exception -> 0x0078 }
        goto L_0x002e;
    L_0x004d:
        r2 = move-exception;
        r6 = getLogger();
    ...
    public static ResponseData readHttpResponse(HttpsURLConnection connection, ActivityPackage activityPackage) throws Exception {
        ...
        try {
            ...
            if (responseCode.intValue() >= HttpStatus.SC_BAD_REQUEST) {
            ...
            if (!(stringResponse == null || stringResponse.length() == 0)) {
                ...
                if (jsonResponse != null) {
                    ...
                    message = jsonResponse.optString(ErrorReport.KEY_MESSAGE, null);
                    responseData.message = message;
                    responseData.timestamp = jsonResponse.optString(ErrorReport.KEY_TIMESTAMP, null);
                    responseData.adid = jsonResponse.optString("adid", null);
                    if (message == null) {
                        message = "No message found";
                    }
                    if (responseCode == null || responseCode.intValue() != BaseRequest.InitBuddyList) {
    ...
    public static String convertToHex(byte[] bytes) {
        ...
        String formatString = "%0" + (bytes.length << 1) + HSFunnel.OPEN_INBOX;
