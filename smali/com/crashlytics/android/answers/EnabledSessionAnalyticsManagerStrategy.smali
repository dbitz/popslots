...
.method public processEvent(Lcom/crashlytics/android/answers/SessionEvent$Builder;)V
    ...
    const-string/jumbo v5, "Custom events tracking disabled - skipping event: "
    ...
    const-string/jumbo v5, "Predefined events tracking disabled - skipping event: "
    ...
    const-string/jumbo v5, "Skipping filtered event: "
...
.method public sendEvents()V
    ...
    const-string/jumbo v5, "skipping files send because we don\'t yet know the target endpoint"
    ...
    const-string/jumbo v5, "Sending all files"
    ...
    const-string/jumbo v6, "attempt to send batch of %d files"
    ...
    const-string/jumbo v6, "Failed to send batch of analytics files to server: "
