...
.method protected getApiKeyFromManifest(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 75
    const-string/jumbo v5, "io.fabric.ApiKey"
    ...
    const-string/jumbo v7, "Falling back to Crashlytics key lookup from Manifest"

    invoke-interface {v5, v6, v7}, Lio/fabric/sdk/android/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V

    .line 80
    const-string/jumbo v5, "com.crashlytics.ApiKey"
    ...
    const-string/jumbo v8, "Caught non-fatal exception while retrieving apiKey: "
...
.method protected getApiKeyFromStrings(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "Falling back to Crashlytics key lookup from Strings"
