...
.method private deleteLegacyInvalidCacheDir()V
    ...
    const-string/jumbo v6, "invalidClsFiles"
...
.method private trimOpenSessions(I)V
    ...
    const-string/jumbo v14, "CrashlyticsCore"

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v16, "Trimming open session file: "
...
.method private writeBeginSession(Ljava/lang/String;Ljava/util/Date;)V
    ...
    const-string/jumbo v9, "BeginSession"
    ...
    const-string/jumbo v8, "Crashlytics Android SDK/%s"
    ...
    .line 889
    const-string/jumbo v5, "Failed to close begin session file."
...
.method private writeExternalCrashEvent(Lcom/crashlytics/android/core/internal/models/SessionEventData;)V
    ...
    const-string/jumbo v9, "Tried to write a native crash while no session was open."
    ...
    .line 818
    const-string/jumbo v7, "Failed to close fatal exception file output stream."
    ...
    const-string/jumbo v9, "SessionCrash"
    ...
    const-string/jumbo v9, "An error occurred in the native crash logger"
    ...
    .line 818
    const-string/jumbo v8, "Failed to close fatal exception file output stream."
...
.method private writeSessionApp(Ljava/lang/String;)V
    ...
    const-string/jumbo v12, "SessionApp"
    ...
    :goto_1
    const-string/jumbo v11, "Failed to flush to session app file."
    ...
    .line 916
    const-string/jumbo v11, "Failed to close session app file."
...
.method private writeSessionOS(Ljava/lang/String;)V
    ...
    .line 936
    const-string/jumbo v6, "Failed to close session OS file."
...
.method private writeSessionUser(Ljava/lang/String;)V
    ...
    :goto_2
    const-string/jumbo v6, "Failed to flush session user file."

    invoke-static {v0, v6}, Lio/fabric/sdk/android/services/common/CommonUtils;->flushOrLog(Ljava/io/Flushable;Ljava/lang/String;)V

    .line 996
    const-string/jumbo v6, "Failed to close session user file."
...
.method doCleanInvalidTempFiles([Ljava/io/File;)V
    ...
    const-string/jumbo v13, "Found invalid session part file: "
    ...
    const-string/jumbo v13, "Deleting all part files for invalid session: "
    ...
    const-string/jumbo v13, "Deleting session file: "
