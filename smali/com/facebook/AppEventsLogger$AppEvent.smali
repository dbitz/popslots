...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Double;Landroid/os/Bundle;Z)V
    ...
    const-string/jumbo v9, "_eventName"
    ...
    const-string/jumbo v9, "_logTime"
    ...
    const-string/jumbo v9, "_valueToSum"
    ...
    const-string/jumbo v9, "_implicitlyLogged"
    ...
    const-string/jumbo v9, "_appVersion"
    ...
    const-string/jumbo v9, "Parameter value \'%s\' for key \'%s\' should be a string or a numeric type."
    ...
    const-string/jumbo v9, "AppEvents"

    const-string/jumbo v10, "JSON encoding for app event failed: \'%s\'"
    ...
    const-string/jumbo v10, "Invalid app event name or parameter:"
    ...
    const-string/jumbo v10, "Created app event \'%s\'"
