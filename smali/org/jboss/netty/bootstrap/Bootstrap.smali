...
.method static isOrderedMap(Ljava/util/Map;)Z
    ...
    const-string/jumbo v16, "OrderedMap"
    ...
    const-string/jumbo v2, "dummyValue"
...
.method public getFactory()Lorg/jboss/netty/channel/ChannelFactory;
    ...
    const-string/jumbo v2, "factory is not set yet."
...
.method public getPipeline()Lorg/jboss/netty/channel/ChannelPipeline;
    ...
    const-string/jumbo v2, "getPipeline() cannot be called if setPipelineFactory() was called."
...
.method public getPipelineAsMap()Ljava/util/Map;
    ...
    const-string/jumbo v2, "pipelineFactory in use"
...
.method public setFactory(Lorg/jboss/netty/channel/ChannelFactory;)V
    ...
    const-string/jumbo v1, "factory can\'t change once set."
...
.method public setPipelineAsMap(Ljava/util/Map;)V
    ...
    const-string/jumbo v4, "pipelineMap"
    ...
    const-string/jumbo v5, "pipelineMap is not an ordered map. Please use "
