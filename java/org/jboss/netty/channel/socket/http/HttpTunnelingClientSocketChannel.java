        ...
        this.realChannel.connect(remoteAddress).addListener(new ChannelFutureListener() {
            public void operationComplete(ChannelFuture f) {
                ...
                if (f.isSuccess()) {
                    ...
                    if (serverName != null) {
                        req.setHeader(Names.HOST, (Object) serverName);
                    }
                    req.setHeader(Names.CONTENT_TYPE, (Object) "application/octet-stream");
                    req.setHeader(HttpHeaders.Names.TRANSFER_ENCODING, (Object) Values.CHUNKED);
                    req.setHeader(HttpHeaders.Names.CONTENT_TRANSFER_ENCODING, (Object) Values.BINARY);
                    req.setHeader(Names.USER_AGENT, (Object) HttpTunnelingClientSocketChannel.class.getName());
