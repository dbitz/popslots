...
public class FriendPickerFragment extends PickerFragment<GraphUser> {
    ...
    public void onInflate(Activity activity, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        setMultiSelect(a.getBoolean(R.styleable.com_facebook_friend_picker_fragment_multi_select, this.multiSelect));
        a.recycle();
    }
    ...
    Request getRequestForLoadData(Session session) {
        ...
        return createRequest(this.userId != null ? this.userId : QuickGameJoinRequest.KEY_MATCH_EXPRESSION, this.extraFields, session);
    }
