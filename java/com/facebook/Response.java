...
public class Response {
    ...
    public String toString() {
        ...
        try {
            ...
            objArr[0] = Integer.valueOf(this.connection != null ? this.connection.getResponseCode() : BaseRequest.InitBuddyList);
            responseCode = String.format(str, objArr);
        } catch (IOException e) {
            responseCode = ClientDisconnectionReason.UNKNOWN;
        }
        ...
        if ($assertionsDisabled || connection != null || isFromCache) {
            ...
            if (numRequests == 1) {
                ...
                try {
                    ...
                    jsonObject.put(CODE_KEY, connection != null ? connection.getResponseCode() : BaseRequest.InitBuddyList);
