...
.method public build()Lcom/google/android/gms/appindexing/Action;
    ...
    const-string/jumbo v1, "setType is required before calling build()."
    ...
    const-string/jumbo v2, "Must call setObject() with a valid name. Example: setObject(new Thing.Builder().setName(name).setUrl(url))"
    ...
    const-string/jumbo v1, "Must call setObject() with a valid app URI. Example: setObject(new Thing.Builder().setName(name).setUrl(url))"
