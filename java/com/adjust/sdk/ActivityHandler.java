...
public class ActivityHandler extends HandlerThread implements IActivityHandler {
    ...
    private SessionHandler sessionHandler = new SessionHandler(getLooper(), this);
    ...
    private void initInternal() {
        ...
        this.timer = new TimerCycle(new Runnable() {
            public void run() {
        ...
        if (responseData.jsonResponse != null) {
            ...
            if (deeplink != null) {
                ...
                if (isIntentSafe) {
                    handler.post(new Runnable() {
                        public void run() {
                            ActivityHandler.this.logger.info("Open deep link (%s)", deeplink);
                            ActivityHandler.this.adjustConfig.context.startActivity(mapIntent);
                        }
                    });
                    return;
                }
