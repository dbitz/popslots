...
.method private applyMultipartDataTo(Lio/fabric/sdk/android/services/network/HttpRequest;Lio/fabric/sdk/android/services/settings/AppRequestData;)Lio/fabric/sdk/android/services/network/HttpRequest;
    ...
    .prologue
    .line 108
    const-string/jumbo v4, "app[identifier]"
    ...
    const-string/jumbo v5, "app[display_version]"
    ...
    const-string/jumbo v5, "app[build_version]"
    ...
    const-string/jumbo v5, "app[source]"
    ...
    const-string/jumbo v5, "app[minimum_sdk_version]"
    ...
    const-string/jumbo v5, "app[built_sdk_version]"
    ...
    .line 117
    const-string/jumbo v4, "app[instance_identifier]"
    ...
    .line 127
    const-string/jumbo v4, "app[icon][hash]"
    ...
    const-string/jumbo v5, "app[icon][data]"

    const-string/jumbo v6, "icon.png"
    ...
    const-string/jumbo v5, "app[icon][width]"
    ...
    const-string/jumbo v5, "app[icon][height]"
    ...
    .line 136
    const-string/jumbo v4, "Failed to close app icon InputStream."
    ...
    const-string/jumbo v7, "Failed to find app icon with resource ID: "
...
.method public invoke(Lio/fabric/sdk/android/services/settings/AppRequestData;)Z
    ...
    const-string/jumbo v6, "Sending app info to "
    ...
    const-string/jumbo v6, "App icon hash is "
    ...
    const-string/jumbo v6, "App icon size is "
    ...
    const-string/jumbo v6, " app request ID: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string/jumbo v6, "X-REQUEST-ID"
