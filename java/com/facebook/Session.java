...
public class Session implements Serializable {
        ...
        if (firstObject.getProperty("permission") != null) {
            for (GraphObject graphObject : data) {
                ...
                if (!permission.equals("installed")) {
                    String status = (String) graphObject.getProperty(IssueColumns.STATUS);
    ...
    public final void close() {
        synchronized (this.lock) {
            SessionState oldState = this.state;
            switch (AnonymousClass5.$SwitchMap$com$facebook$SessionState[this.state.ordinal()]) {
    ...
    void extendTokenCompleted(android.os.Bundle r6) {
        ...
        r2 = r5.lock;
        monitor-enter(r2);
        r0 = r5.state;	 Catch:{ all -> 0x0052 }
        r1 = com.facebook.Session.AnonymousClass5.$SwitchMap$com$facebook$SessionState;	 Catch:{ all -> 0x0052 }
        r3 = r5.state;	 Catch:{ all -> 0x0052 }
        r3 = r3.ordinal();	 Catch:{ all -> 0x0052 }
        r1 = r1[r3];	 Catch:{ all -> 0x0052 }
        switch(r1) {
    ...
    L_0x0012:
        ...
        r4 = r5.state;	 Catch:{ all -> 0x0052 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x0052 }
        r3 = r3.toString();	 Catch:{ all -> 0x0052 }
        android.util.Log.d(r1, r3);	 Catch:{ all -> 0x0052 }
        monitor-exit(r2);	 Catch:{ all -> 0x0052 }
    L_0x002e:
        return;
    L_0x002f:
        r1 = com.facebook.SessionState.OPENED_TOKEN_UPDATED;	 Catch:{ all -> 0x0052 }
        r5.state = r1;	 Catch:{ all -> 0x0052 }
        r1 = r5.state;	 Catch:{ all -> 0x0052 }
        r3 = 0;
        r5.postStateChange(r0, r1, r3);	 Catch:{ all -> 0x0052 }
    L_0x0039:
        r1 = r5.tokenInfo;	 Catch:{ all -> 0x0052 }
        r1 = com.facebook.AccessToken.createFromRefresh(r1, r6);	 Catch:{ all -> 0x0052 }
        r5.tokenInfo = r1;	 Catch:{ all -> 0x0052 }
        r1 = r5.tokenCachingStrategy;	 Catch:{ all -> 0x0052 }
        if (r1 == 0) goto L_0x0050;
    L_0x0045:
        r1 = r5.tokenCachingStrategy;	 Catch:{ all -> 0x0052 }
        r3 = r5.tokenInfo;	 Catch:{ all -> 0x0052 }
        r3 = r3.toCacheBundle();	 Catch:{ all -> 0x0052 }
        r1.save(r3);	 Catch:{ all -> 0x0052 }
    L_0x0050:
        monitor-exit(r2);	 Catch:{ all -> 0x0052 }
        goto L_0x002e;
    L_0x0052:
    ...
    void authorize(AuthorizationRequest request) {
        ...
        this.pendingAuthorizationRequest.loggingExtras.put("try_login_activity", started ? HSConsts.STATUS_INPROGRESS : HSConsts.STATUS_NEW);
        if (!started && request.isLegacy) {
            this.pendingAuthorizationRequest.loggingExtras.put("try_legacy", HSConsts.STATUS_INPROGRESS);
    ...
    L_0x001e:
        ...
        r2 = com.facebook.Session.AnonymousClass5.$SwitchMap$com$facebook$SessionState;	 Catch:{ all -> 0x0036 }
        r4 = r7.state;	 Catch:{ all -> 0x0036 }
    ...
    boolean shouldExtendAccessToken() {
        ...
        Date now = new Date();
        if (!this.state.isOpened() || !this.tokenInfo.getSource().canExtendToken() || now.getTime() - this.lastAttemptedTokenExtendDate.getTime() <= 3600000 || now.getTime() - this.tokenInfo.getLastRefresh().getTime() <= ErrorReport.BATCH_TIME) {
            return false;
        }
        return true;
    }
