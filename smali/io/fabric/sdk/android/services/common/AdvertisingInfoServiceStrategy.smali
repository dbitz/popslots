...
.method public getAdvertisingInfo()Lio/fabric/sdk/android/services/common/AdvertisingInfo;
    ...
    const-string/jumbo v9, "AdvertisingInfoServiceStrategy cannot be called on the main thread"
    ...
    const-string/jumbo v9, "Unable to find Google Play Services package name"
    ...
    const-string/jumbo v9, "Unable to determine if Google Play Services is available"
    ...
    const-string/jumbo v9, "Exception in binding to Google Play Service to capture AdvertisingId"
    ...
    const-string/jumbo v9, "Could not bind to Google Play Service to capture AdvertisingId"
