...
public final class Util {
    ...
    public static String openUrl(String url, String method, Bundle params) throws MalformedURLException, IOException {
        ...
        conn.setRequestProperty(Names.USER_AGENT, System.getProperties().getProperty("http.agent") + " FacebookAndroidSDK");
        if (!method.equals("GET")) {
            ...
            conn.setRequestProperty(Names.CONTENT_TYPE, "multipart/form-data;boundary=" + strBoundary);
    ...
    private static String read(InputStream in) throws IOException {
        StringBuilder sb = new StringBuilder();
        BufferedReader r = new BufferedReader(new InputStreamReader(in), PlacePickerFragment.DEFAULT_RADIUS_IN_METERS);
    ...
    public static JSONObject parseJson(String response) throws JSONException, FacebookError {
        ...
        if (json.has(NativeProtocol.BRIDGE_ARG_ERROR_BUNDLE)) {
            ...
            throw new FacebookError(error.getString(ErrorReport.KEY_MESSAGE), error.getString(MessageColumns.TYPE), 0);
