...
public interface GraphObject {
    ...
    public static final class Factory {
        ...
        public static boolean hasSameId(GraphObject a, GraphObject b) {
            if (a == null || b == null || !a.asMap().containsKey(LoginRequest.KEY_ID) || !b.asMap().containsKey(LoginRequest.KEY_ID)) {
                return false;
            }
            if (a.equals(b)) {
                return true;
            }
            Object idA = a.getProperty(LoginRequest.KEY_ID);
            Object idB = b.getProperty(LoginRequest.KEY_ID);
