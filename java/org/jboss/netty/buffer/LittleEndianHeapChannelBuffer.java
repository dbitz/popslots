...
public class LittleEndianHeapChannelBuffer extends HeapChannelBuffer {
    ...
    public int getInt(int index) {
        return ((((this.array[index] & 255) << 0) | ((this.array[index + 1] & 255) << 8)) | ((this.array[index + 2] & 255) << 16)) | ((this.array[index + 3] & 255) << 24);
    }

    public long getLong(int index) {
        return ((((((((((long) this.array[index]) & 255) << null) | ((((long) this.array[index + 1]) & 255) << 8)) | ((((long) this.array[index + 2]) & 255) << 16)) | ((((long) this.array[index + 3]) & 255) << 24)) | ((((long) this.array[index + 4]) & 255) << 32)) | ((((long) this.array[index + 5]) & 255) << 40)) | ((((long) this.array[index + 6]) & 255) << 48)) | ((((long) this.array[index + 7]) & 255) << 56);
    }
    ...
    public void setLong(int index, long value) {
        this.array[index] = (byte) ((int) (value >>> null));
