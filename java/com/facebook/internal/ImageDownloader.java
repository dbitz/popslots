...
public class ImageDownloader {
    ...
    private static void download(com.facebook.internal.ImageDownloader.RequestKey r19, android.content.Context r20) {
        ...
        r2 = 0;
        r10 = 1;
        r15 = new java.net.URL;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r0 = r19;
        r0 = r0.uri;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r16 = r0;
        r16 = r16.toString();	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r15.<init>(r16);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r16 = r15.openConnection();	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r0 = r16;
        r0 = (java.net.HttpURLConnection) r0;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r5 = r0;
        r16 = 0;
        r0 = r16;
        r5.setInstanceFollowRedirects(r0);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r16 = r5.getResponseCode();	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        switch(r16) {
            case 200: goto L_0x00b9;
            case 301: goto L_0x006c;
            case 302: goto L_0x006c;
            default: goto L_0x002b;
        };	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
    L_0x002b:
        r14 = r5.getErrorStream();	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r9 = new java.lang.StringBuilder;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r9.<init>();	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        if (r14 == 0) goto L_0x00d3;
    L_0x0036:
        r11 = new java.io.InputStreamReader;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r11.<init>(r14);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r16 = 128; // 0x80 float:1.8E-43 double:6.3E-322;
        r0 = r16;
        r3 = new char[r0];	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
    L_0x0041:
        r16 = 0;
        r0 = r3.length;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r17 = r0;
        r0 = r16;
        r1 = r17;
        r4 = r11.read(r3, r0, r1);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        if (r4 <= 0) goto L_0x00c4;
    L_0x0050:
        r16 = 0;
        r0 = r16;
        r9.append(r3, r0, r4);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        goto L_0x0041;
    L_0x0058:
        r7 = move-exception;
        r8 = r7;
    ...
    L_0x006c:
        ...
        r16 = "location";
        r0 = r16;
        r12 = r5.getHeaderField(r0);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r16 = com.facebook.internal.Utility.isNullOrEmpty(r12);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        if (r16 != 0) goto L_0x00b2;
    L_0x007c:
        r13 = new java.net.URI;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r13.<init>(r12);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r0 = r19;
        r0 = r0.uri;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r16 = r0;
        r0 = r20;
        r1 = r16;
        com.facebook.internal.UrlRedirectCache.cacheUriRedirect(r0, r1, r13);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r6 = removePendingRequest(r19);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        if (r6 == 0) goto L_0x00b2;
    L_0x0094:
        r0 = r6.isCancelled;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r16 = r0;
        if (r16 != 0) goto L_0x00b2;
    L_0x009a:
        r0 = r6.request;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r16 = r0;
        r17 = new com.facebook.internal.ImageDownloader$RequestKey;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r0 = r19;
        r0 = r0.tag;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r18 = r0;
        r0 = r17;
        r1 = r18;
        r0.<init>(r13, r1);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r18 = 0;
        enqueueCacheRead(r16, r17, r18);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
    L_0x00b2:
        com.facebook.internal.Utility.closeQuietly(r14);
        com.facebook.internal.Utility.disconnectQuietly(r5);
        goto L_0x0060;
    L_0x00b9:
        r0 = r20;
        r14 = com.facebook.internal.ImageResponseCache.interceptAndCacheImageStream(r0, r5);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r2 = android.graphics.BitmapFactory.decodeStream(r14);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        goto L_0x00b2;
    L_0x00c4:
        com.facebook.internal.Utility.closeQuietly(r11);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
    L_0x00c7:
        r8 = new com.facebook.FacebookException;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r16 = r9.toString();	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r0 = r16;
        r8.<init>(r0);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        goto L_0x00b2;
    L_0x00d3:
        r16 = com.facebook.android.R.string.com_facebook_image_download_unknown_error;	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r0 = r20;
        r1 = r16;
        r16 = r0.getString(r1);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        r0 = r16;
        r9.append(r0);	 Catch:{ IOException -> 0x0058, URISyntaxException -> 0x00e3, all -> 0x00ed }
        goto L_0x00c7;
    L_0x00e3:
        r7 = move-exception;
        r8 = r7;
